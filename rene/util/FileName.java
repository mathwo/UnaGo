...
public class FileName {
    ...
    static public String chop(int start, String filename) {
        return FileName.chop(start, filename, FileName.ChopLength);
    }
    ...
    static public String chop(String filename) {
        return FileName.chop(filename, FileName.ChopLength);
    }
    ...
    public static boolean match(String filename, String filter) {
        ...
        return FileName.match(fn, 0, f, 0);
    }
    ...
    static public String toURL(String filename) {
        ...
        if (n >= 0) {
            return filename.substring(0, n) + "%20"
                    + FileName.toURL(filename.substring(n + 1));
        } else {
            return filename;
        }
    }
