...
public class FTP {
    ...
    static void testGet(InputStream in) throws IOException {
        final BufferedReader In = new BufferedReader(new InputStreamReader(in));
        while (true) {
    ...
    static void testPut(OutputStream out) throws IOException {
        final PrintWriter Out = new PrintWriter(out);
     ...
     */
    public Socket passive() throws IOException, UnknownHostException,
